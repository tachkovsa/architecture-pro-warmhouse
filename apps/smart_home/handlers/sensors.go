...
func NewSensorHandler(sensorsService *services.SensorsService, temperatureService *services.TemperatureService) *SensorHandler {
...
func (h *SensorHandler) GetSensors(c *gin.Context) {
	sensors, err := h.SensorsService.GetSensors(context.Background())
	if err != nil {
...
func (h *SensorHandler) GetSensorByID(c *gin.Context) {
	...
	sensor, err := h.SensorsService.GetSensorByID(context.Background(), id)
...
func (h *SensorHandler) CreateSensor(c *gin.Context) {
	var sensorCreate map[string]interface{}
	if err := c.ShouldBindJSON(&sensorCreate); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	sensor, err := h.SensorsService.CreateSensor(context.Background(), sensorCreate)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *SensorHandler) UpdateSensor(c *gin.Context) {
	...
	var sensorUpdate map[string]interface{}
	if err := c.ShouldBindJSON(&sensorUpdate); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	sensor, err := h.SensorsService.UpdateSensor(context.Background(), id, sensorUpdate)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *SensorHandler) DeleteSensor(c *gin.Context) {
	...
	err = h.SensorsService.DeleteSensor(context.Background(), id)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *SensorHandler) UpdateSensorValue(c *gin.Context) {
	...
	err = h.SensorsService.UpdateSensorValue(context.Background(), id, request.Value, request.Status)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
